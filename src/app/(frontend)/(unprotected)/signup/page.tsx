...
export default function Page() {
  return (
    <div className="flex flex-1 w-full items-center justify-center p-6 md:p-10">
      <div className="fixed left-0 right-0 top-[15%] border-t border-dashed pointer-events-none"></div>
      ...
      <div className="fixed left-0 right-0 bottom-[10%] border-b border-dashed pointer-events-none"></div>
